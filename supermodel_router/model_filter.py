...
- 支持 7 维筛选: provider / context range / quality min / speed min / reasoning min / modality / tags (any/all)
...
def apply_filter(filter_: ModelFilter, models: List[Any]) -> List[Any]:
    ...
    - quality/speed/reasoning min: model.xxx_score >= min (0 = 未知, 默认通过, 但 min > 0 时强制检查)
